...
```bash
python3 tools/build_release.py build --output-dir /private/release-0.2.1 \
  --expected-tag v0.2.1 --source-date-epoch 0
python3 tools/build_release.py verify /private/release-0.2.1
```
